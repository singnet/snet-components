...
class SNETAudioUpload extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            outputImage:
                ...
                SNETAudioUpload.prepareBase64Image(this.props.outputImage),
        ...
        this.fileSizeError =
            ...
            this.props.maxImageSize / 1000000 +
            'mb).';
        this.fileTypeError =
            'File type not accepted. Allowed: ' +
            this.props.allowedInputTypes +
            '.';
        ...
        this.setInitialImageXPosition =
            this.setInitialImageXPosition.bind(this);
        ...
        if (nextProps.outputImage) {
            if (nextProps.outputImage !== this.props.outputImage) {
                if (nextProps.outputImageMimeType === undefined) {
                    mimeType = SNETAudioUpload.getBase64ImageType(
                ...
                this.setState({
                    ...
                    outputImage: SNETAudioUpload.addBase64Header(
                        mimeType,
                        nextProps.outputImage
                    ),
            ...
            if (this.props.allowedInputTypes.includes('image/*')) {
                ...
                if (mimeType.indexOf('image') === -1) {
                    ...
                    this.displayErrorMessage(
                        this.fileTypeError + 'Got: ' + mimeType + '.'
                    );
                    return;
                }
            } else {
    ...
    renderUploadTab() {
        ...
        return (
            ...
            >
                <FileDrop
                    onDrop={(files, event) =>
                        this.handleImageUpload(files, event)
                    }
                >
                    <input
                        id='myInput'
                        ...
                        onChange={(e) =>
                            this.handleImageUpload(e.target.files, e)
                        }
                    ...
                    >
                        <div className={classes.uploadBoxContent}>
                            ...
                            >
                                (Image must be under{' '}
                                {this.props.maxImageSize / 1000000}mb. Source
                                images are not saved on the servers after the
                                job is processed.)
                            </Typography>
                        </div>
                    </div>
        ...
        return (
            <Fade in={this.state.mainState === 'uploaded'}>
                <div
                    ...
                    onMouseOver={() =>
                        this.setState({ displayImageName: true })
                    }
                    onMouseLeave={() =>
                        this.setState({ displayImageName: false })
                    }
                >
                    <img
                        alt='Service input'
    ...
    renderTabs() {
        ...
        return (
            <div className={(classes.tabStyle, classes.tabsMainContainer)}>
                ...
                <ClickAwayListener
                    onClickAway={() => this.setState({ displayError: false })}
                >
                    <Snackbar
                        ...
                        <SnackbarContent
                            ...
                            message={
                                <span style={{ color: snetGreyError }}>
                                    ...
                                    />
                                    <Typography style={{ color: snetGrey }}>
    ...
    *  -----------------*/
    ...
    handleMouseMove(event) {
        ...
        let offsetImageLeft =
            this.outputImage.current.getBoundingClientRect().left;
        this.setState({
            ...
            <Fade in={this.state.mainState === 'display'}>
                ...
                >
                    ...
                    <img
                        ...
                        height={
                            this.props.overlayInputImage &&
                            this.state.inputImageHeight
                        }
                        width={
                            this.props.overlayInputImage &&
                            this.state.inputImageWidth
                        }
                        alt='Service response...'
                        src={this.state.outputImage}
                    />
            ...
            <div className={classes.mainContainer}>
                ...
                >
                            ...
                            {this.state.mainState === 'uploaded' &&
                                !this.props.disableResetButton && (
                                    ...
                                    >
                                        ...
                                        >
                                            <IconButton
                                                onClick={this.handleImageReset.bind(
                                                    this
                                                )}
                                            >
                                                <RefreshIcon
                    ...
                    <Grid
                        item
                        xs={12}
                        style={{ backgroundColor: snetBackgroundGrey }}
                    >
