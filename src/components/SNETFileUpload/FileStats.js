    ...
    return (
        <div className={classes.imgUploaderContainer}>
            <div className={classes.uploadDetails}>
                <div
                    className={
                        uploadSuccess ? classes.successfullUpload : classes.uploadStatusContainer
                    }
                >
                ...
                <div className={classes.uploadBtns}>
                    ...
                    {/* <Button children="delete files" color="red" variant="text" disabled={!uploadSuccess} />
                     */}{" "}
                </div>
            </div>
        </div>
